        ...
        <div className="bg-white bg-opacity-90 dark:bg-gray-900/90 rounded-2xl shadow-2xl border border-[#008000] border-opacity-30 p-8 md:p-12 text-black dark:text-gray-100">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              en su totalidad. Si no estás de acuerdo con alguno de los
              términos, no debes usar la plataforma.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              MoTaxi es una plataforma digital que conecta pasajeros con
              conductores en el Valle de Sibundoy, Putumayo,
              Colombia. MoTaxi actúa exclusivamente como intermediario
              tecnológico y no es una empresa de transporte.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-1 pl-2">
              <li>
                Poseen la licencia de conducción vigente y habilitada para
                mototaxi
              </li>
              <li>
              ...
              <li>
                Cumplen con la normativa local de transporte en el Valle de
                Sibundoy
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              pasajeros. El método y monto de pago por cada viaje es acordado
              directamente entre las partes. MoTaxi no asume ninguna
              responsabilidad sobre las transacciones económicas realizadas
              entre usuarios.
            </p>
          </section>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold mb-3">
              6. Suscripción de conductores
            </h2>
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              Los conductores pueden adquirir una suscripción mensual para
              acceder a la plataforma. Los pagos de suscripción son procesados
              por ePayco. MoTaxi no almacena datos de tarjetas de crédito. Las
              suscripciones no son reembolsables una vez activadas, salvo en
              casos de falla técnica comprobable atribuible a MoTaxi.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              MoTaxi no es responsable por accidentes, lesiones, pérdidas o
              daños ocurridos durante los viajes. La relación entre conductores
              y pasajeros es directa y autónoma. MoTaxi tampoco es responsable
              por interrupciones del servicio causadas por fallas técnicas, de
              conectividad o de terceros.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              ...
              página. El uso continuado de la plataforma tras los cambios
