    ...
    >
      ...
      <div className="max-w-3xl mx-auto px-4 py-24">
        <div className="bg-white bg-opacity-90 dark:bg-gray-900/90 rounded-2xl shadow-2xl border border-[#008000] border-opacity-30 p-8 md:p-12 text-black dark:text-gray-100">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-8">Última actualización: 1 de abril de 2026</p>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
              MoTaxi accede a tu ubicación en tiempo real únicamente cuando tienes un viaje activo, y se comparte
              solamente con la otra parte del viaje (conductor o pasajero). Las direcciones y coordenadas de origen
              y destino de cada viaje, así como la ruta recorrida, se conservan como parte de tu historial de viajes
              para ofrecerte el servicio, mostrar tu historial y mejorar la plataforma.
            </p>
          </section>
