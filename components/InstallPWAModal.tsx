  ...
  return (
    <div className="fixed inset-0 z-[9998] flex items-end justify-center sm:items-center bg-black/50 backdrop-blur-sm px-4 pb-4 sm:pb-0">
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-sm overflow-hidden animate-slide-up">
        {/* Header verde */}
        <div className="bg-[#008000] px-6 pt-6 pb-8 text-center relative">
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          {/* Instrucciones iOS */}
          {isIOS && (
            <div className="bg-[#008000]/10 border border-[#008000]/30 rounded-2xl p-4 space-y-2">
              <p className="text-xs font-semibold text-[#003300] uppercase tracking-wide">Cómo instalar en iPhone/iPad</p>
              <div className="flex items-start gap-2 text-sm text-[#003300]">
                <span className="shrink-0">1.</span>
                <span>Toca el botón <strong>Compartir</strong> <span className="inline-block border border-[#008000] rounded px-1">⬆</span> en la barra inferior de Safari.</span>
              </div>
              <div className="flex items-start gap-2 text-sm text-[#003300]">
          ...
          <div className="flex flex-col gap-2 pt-1">
            {!isIOS && (
              <button
                ...
                className="w-full py-3 bg-[#008000] hover:bg-[#38b518] text-white font-semibold rounded-2xl transition-colors"
              >
                Instalar ahora
              </button>
            )}
